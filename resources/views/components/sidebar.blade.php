<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/">
            <img src="../assets/img/sipasti_icon.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold">SIPASTI</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ (request()->is('/') ? 'active' : '' || request()->is('kontrak*')) ? 'active' : '' }}"
                    href="/">
                    <div
            ...
            <li class="nav-item">
                <form action="/logout" method="POST">
                    ...
                    <button type="submit" class="nav-link" style="background: none; border: none;">
                        <div
                            class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="ni ni-bold-left text-danger text-sm opacity-10"></i>
                        </div>
